...
### Package: bili-rust (`spec/bili-rust/`)

- Backend guidelines: `.trellis/spec/bili-rust/backend/`

### Package: bili-rust-ui (`spec/bili-rust-ui/`)

- Backend guidelines: `.trellis/spec/bili-rust-ui/backend/`
